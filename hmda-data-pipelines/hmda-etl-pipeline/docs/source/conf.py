...
# hmda_etl_pipeline documentation build
...
from hmda_etl_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "hmda_etl_pipeline"
author = "Kedro"
...
htmlhelp_basename = "hmda_etl_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "hmda_etl_pipeline.tex",
        "hmda_etl_pipeline Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "hmda_etl_pipeline",
        "Project hmda_etl_pipeline codebase.",
        "Data-Science",
    )
]
